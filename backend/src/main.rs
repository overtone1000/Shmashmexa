...
async fn main() {
    ...
    let params:InitializationParameters=match dev_mode
    {
        true=>{
            ...
            InitializationParameters::new(DEV_INTERNAL_SERVICE_DIR,DEV_INTERNAL_PORT,DEV_EXTERNAL_PORT)
        },
        false=>{
            println!("Running in production mode.");
            InitializationParameters::new(PROD_INTERNAL_SERVICE_DIR,PROD_INTERNAL_PORT,PROD_EXTERNAL_PORT)
        }
    };
