...
use hyper_services::{
    commons::HandlerResult, request_processing::get_request_body_as_string, response_building::{bad_request, full_to_boxed_body}, service::{stateful_service::StatefulHandler, stateless_service::StatelessHandler}
};
#[derive(Clone)]
pub struct InternalWebsocketService {
}

impl StatefulHandler for InternalWebsocketService {
